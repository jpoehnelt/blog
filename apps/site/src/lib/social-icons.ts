 ...
 * These can be used with the Navbar component's socialLinks prop
 */
...
/**
 * Helper function to create a social link object for the Navbar component
 */
...
/**
 * Common social links - customize these URLs for your own use
 */
export function getDefaultSocialLinks(config: {
  github?: string;
  linkedin?: string;
  twitter?: string;
  bluesky?: string;
  ...
  if (config.github) links.push(createSocialLink("github", config.github));
  if (config.linkedin)
    links.push(createSocialLink("linkedin", config.linkedin));
  if (config.twitter) links.push(createSocialLink("twitter", config.twitter));
  if (config.bluesky) links.push(createSocialLink("bluesky", config.bluesky));
  if (config.mastodon)
    links.push(createSocialLink("mastodon", config.mastodon));
  if (config.youtube) links.push(createSocialLink("youtube", config.youtube));
