...
<script>
  import img_automators_hole_jpeg from "$lib/images/automators-hole.jpeg?enhanced";
...
<Image src={img_automators_hole_jpeg} alt="Automator's Hole" />
...
In reality, I just need to do the tasks and stop procrastination. I think I'll go do that now. 😀
