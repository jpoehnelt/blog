...
<script>
  import img_mogollon_blood_glucose_levels_png from "$lib/images/mogollon-blood-glucose-levels.png?enhanced";
...
<Image src={img_mogollon_blood_glucose_levels_png} alt="My blood glucose values during the race" />
