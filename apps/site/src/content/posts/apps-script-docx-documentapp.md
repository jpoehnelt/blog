---
title: Convert docx to Google Docs with Apps Script
description: >-
  Programmatically convert, open, and edit Microsoft Word .docx files in Google
  Apps Script using the Drive API and DocumentApp.
pubDate: "2024-04-30"
tags:
  - code
  - google
