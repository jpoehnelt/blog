import { getStravaSegment, getStravaSegmentActivities } from "$lib/content/strava";
...
export const load: PageServerLoad = async ({ params }) => {
  ...
  const effortData = activities
        ...
        .filter((d): d is { elapsed_time: number; average_heartrate: number; start_date: string; id: string } => d !== null && d.average_heartrate !== undefined && d.elapsed_time !== undefined);
